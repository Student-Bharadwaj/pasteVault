...
export default function Header() {
  return (
   <nav className=' flex items-center justify-around w-screen py-5 gap-10'>
    <NavLink className="text-3xl md:text-5xl font-semibold bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 bg-clip-text text-transparent " to="/">PasteVault</NavLink>
    <div className=' flex gap-4 md:gap-10 text-lg md:text-2xl font-normal'>
